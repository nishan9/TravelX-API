        ...
        try {
            if (checkDateFormat(date) && isDateWithin16Days(date)) {
                String url = "https://api.open-meteo.com/v1/forecast?latitude=" + latitude + "&longitude=" + longitude +
                        ...
                        "precipitation_probability_max,windspeed_10m_max&timezone=GMT&start_date=" + date + "&end_date="
                        + date;
                ...
                WeatherModel weatherModel = new WeatherModel(summary, maxTemp, minTemp, maxApparentTemp,
                        minApparentTemp,
